...
//Minh viet code trong file cpp r bo vao trong nay nha
//Minh thuong la se lam cai outline cua cai project la cai ham truoc y
//Neu sai gi thi moi nguoi noi lai nha
//Voi co cai tien gi thi moi nguoi cung gop y nha. 
//Minh muon di hoc them ve tinh hoa the gioi lam :)))
